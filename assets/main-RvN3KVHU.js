...
const __vite_import_meta_env__ = { "BASE_URL": "/email-assistant-v8-clean/", "DEV": false, "MODE": "production", "PROD": true, "SSR": false };
  ...
  reactExports.useEffect(() => {
    const loadTemplatesData = async () => {
      ...
      try {
        ...
        const BASE_URL = typeof import.meta !== "undefined" && __vite_import_meta_env__ && "/email-assistant-v8-clean/" ? "/email-assistant-v8-clean/" : "/";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "w-full max-w-none px-3 sm:px-4 lg:px-6 py-5", children: [
        !loading && (!templatesData || !Array.isArray(templatesData.templates) || templatesData.templates.length === 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 p-4 rounded-lg border-2 border-amber-300 bg-amber-50 text-amber-900 shadow-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
            interfaceLanguage === "fr" ? "Le fichier complete_email_templates.json n'a pas été trouvé ou n'a pas pu être chargé. Le bouton d'envoi s'affiche uniquement quand un modèle est sélectionné." : "The complete_email_templates.json file was not found or could not be loaded. The Send Email button only shows when a template is selected.",
